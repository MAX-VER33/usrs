...
<!--        <el-menu-item index="1"><router-link to="/dp">首页</router-link></el-menu-item>-->
        ...
        <el-sub-menu index="9">
          ...
          <el-sub-menu index="9-1">
            <template #title>考研</template>
            <el-menu-item index="9-1-1"><router-link to="/Compare">院校对比</router-link></el-menu-item>
            <el-menu-item index="9-1-2"><router-link to="/Information">考研信息</router-link></el-menu-item>
          </el-sub-menu>
          <el-menu-item index="9-2">保研</el-menu-item>
          <el-menu-item index="9-3">找工作</el-menu-item>
          <el-menu-item index="9-4">竞赛</el-menu-item>
          <el-menu-item index="9-5">招聘</el-menu-item>
          <el-menu-item index="9-6">其他</el-menu-item>
        </el-sub-menu>
